  ...
  Future<void> _processImage(InputImage inputImage) async {
    ...
    try {
      ...
      if (inputImage.metadata?.size != null &&
        ...
        if (poses.isNotEmpty) {
           String rawAnalysis = PostureAnalyzer.analyzePose(poses.first);
           if (rawAnalysis == "Good Posture") {
             status = "Good";
           } else if (rawAnalysis != "Calculating..." && rawAnalysis != "Body not fully visible") {
             status = "Bad";
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Text("Squat Analysis", style: UIStyles.heading),
                        SizedBox(height: 4),
                        Row(
                          children: [
